...
public class Picture extends SimplePicture 
{
  ...
  /** Method to make whole picture gray */
  public void grayscale()
  {
    ...
    * @param size    Size length of sqaure area to pixelate 
    */
  public Pixel[][] pixelate(int size)
  {
	Pixel[][] pixels = this.getPixels2D();
	Pixel[][] sizePixel = new Pixel[pixels.length/size][pixels[0].length/size];
    for (Pixel[] rowArray : pixels)
    {
      for (Pixel[] pixelObj : rowArray)
      {
